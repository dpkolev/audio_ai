...
public class FFTCol_Orig {
	...
	public static void main(String[] args) {
		...
		FFTCol_Orig fft = new FFTCol_Orig(N);
		...
		beforeAfter(fft, re, im, "Single sin");
	...
	protected static void beforeAfter(FFTCol_Orig fft, double[] re, double[] im, String testName) {
